...
public class ProblemController {
	...
	@RequestMapping(value = "/newlist/{labelid}/{page}/{rows}",method = RequestMethod.GET)
	public Result newlist(@PathVariable String labelid,@PathVariable int page,@PathVariable int rows){
